...
**Для владельца платформы (Ирина):** Вариант Б — уже работает ✅  
Новая заявка с сайта → уведомление в Telegram.

**Для клиентов бизнеса (стоматологии, бьюти и т.д.):** оба варианта, клиент выбирает:

| Вариант | Что делает | Кто выбирает |
|---------|-----------|-------------|
| Б | Уведомления о новых заявках → в Telegram владельца бизнеса | По умолчанию для всех |
| В | Клиенты бизнеса пишут боту вместо формы на сайте | По желанию, опционально |

При подключении нового бизнеса спрашиваем: "Хочешь Telegram-бот для своих клиентов?" — и настраиваем нужный вариант.
